...
// v2 : intégration effective d'embeds tiers (YouTube, Vimeo, Matterport,
// Instagram, TikTok, Facebook…) sur les fiches biens -> nouveau recueil du
// consentement pour un choix éclairé sur ces transferts.
...
export const services = [
  ...
  },
  {
    ...
    requiresConsent: true,
    // Intégré via <PropertyMedia> / <ConsentAwareEmbed> sur les fiches
    // /biens/[slug] : l'iframe du fournisseur n'est créée qu'après consentement.
    active: true,
    doc: {
